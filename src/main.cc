...
*createBB (Function &fn, string name)
{
  ...
  ListDigraph::Node n0 = bb -> addInstruction (*i0);
...
*createF1 (CFG &cfg)
{
  ...
  ListDigraph::Node n0 = fn -> addEntryPoint (*bb0);
  ListDigraph::Node n1 = fn -> addBasicBlock (*bb1);
  ListDigraph::Node n2 = fn -> addBasicBlock (*bb2);
  ListDigraph::Node nx = fn -> addExitNode ();
